            ...
            : data.map((product, index) => {
                return (
                  <div
                    ...
                    className="w-full bg-slate-50 h-36 my-4 border border-slate-300  rounded grid grid-cols-[128px,1fr]"
                  >
                    ...
                    <div className="px-4 py-2 relative">
                      ...
                      <div className="flex items-center gap-3 mt-2">
                        <button
                          className="border border-red-600 text-red-600 hover:bg-red-600 hover:text-white w-6 h-6 pb-1 flex justify-center items-center rounded "
                          onClick={() =>
                        ...
                        <span className="transition-all">{product?.quantity}</span>
                        <button
                          className="border border-red-600 text-red-600 hover:bg-red-600 hover:text-white w-6 h-6 pb-1 flex justify-center items-center rounded "
                          onClick={() =>
        ...
        <div className="mt-5 lg:mt-0 w-full max-w-sm">
          {loading ? (
            ...
            <div className="h-72 my-4 bg-white p-2 border border-slate-300">
              <h2 className="text-red-500 px-4 py-4 font-semibold">
                PRICE DETAILS
              </h2>
              ...
              <div className="w-full h-[1px] bg-slate-600 opacity-25 my-4">

              </div>
              <div className="flex items-center justify-between px-4 gap-2 my-2 text-base font-semibold text-black">
                <p>Total Amount</p>
                <p className="text-black">
                  {displayINRCurrency(finalPrice)}
                </p>
              </div>

              <button className="bg-red-500 p-2 mt-4 text-white w-full mx-auto tracking-wider font-bold">
                PLACE ORDER
              </button>
            </div>
          )}
